...
```{r doublingtime, echo=FALSE, out.width="5%", purl=FALSE}
knitr::include_graphics("mun.jpg")
```

TITLE: Submission portal for Rapid Antigen Tests completed January 22 and/or 25	by K-12 students in Newfoundland and Labrador

RESEARCHER: Dr. Amy Hurford
...
\
<u>Eligibility</u>: At least one member of your household attends elementary, middle, or high school in Newfoundland and Labrador (one submission per household for both January 22 and 25). 
...
The survey will open January 25 - February 8, given Health Research Ethics Approval, and if the Government of Newfoundland and Labrador does not provide an alternative submission portal.
</div>
